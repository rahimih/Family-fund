...
{
    public partial class Report_debtPaymentMembersSum_F : Form
    {
        public DLibraryUtils.DLUtils DLUtilsobj;
        familial_bankEntities familial_bankEntitiescontext;
        bool openExportFile = false;

        public Report_debtPaymentMembersSum_F()
        {
            InitializeComponent();
        }
        ...
        {
            DLUtilsobj.temperory2obj.ReportdebtpaymentmembersSum(persianDateTimePicker2.Value.ToString("yyyy/MM/dd"), persianDateTimePicker1.Value.ToString("yyyy/MM/dd"));
