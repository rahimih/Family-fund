...
{
    public partial class PaymentMembersRight_View_F : Form
    {
        public DLibraryUtils.DLUtils DLUtilsobj;
        familial_bankEntities familial_bankEntitiescontext;
        public int usercode, code;

        public PaymentMembersRight_View_F()
        {
            InitializeComponent();
        }
        ...
        private void radGridView1_SelectionChanging(object sender, Telerik.WinControls.UI.GridViewSelectionCancelEventArgs e)
        {
            ...
            DLUtilsobj.temperory2obj.PaymentMembersRightview(int.Parse(radGridView1.CurrentRow.Cells[0].Value.ToString()));
