...
{
    public partial class Report_PaymentMonthly_F : Form
    {
        public DLibraryUtils.DLUtils DLUtilsobj;
        familial_bankEntities familial_bankEntitiescontext;
        bool openExportFile = false;
      
        public Report_PaymentMonthly_F()
        {
            InitializeComponent();
        }
        ...
        {
            DLUtilsobj.temperory2obj.ReportpaymentMonthly(persianDateTimePicker2.Value.ToString("yyyy/MM/dd"), persianDateTimePicker1.Value.ToString("yyyy/MM/dd"));
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            radPrintDocument1.RightHeader = "مبلغ واریزی ماهیانه به تفکیک";
