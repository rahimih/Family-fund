...
{
    public partial class Report_monthlypayment_F : Form
    {
        ...
        public Report_monthlypayment_F()
        {
            InitializeComponent();
        }
        ...
        {
            DLUtilsobj.temperoryobj.report_monthlypayments(memberscode);
            ...
            if (radGridView1.RowCount > 0)
            {
                ...
                radGridView1.Columns[2].HeaderText = "مبلغ";
                radGridView1.Columns[3].HeaderText = "سال";
                radGridView1.Columns[4].HeaderText = "ماه";
                radGridView1.Columns[5].HeaderText = "شماره سریال";
                radGridView1.Columns[6].HeaderText = "توضیحات";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            radPrintDocument1.RightHeader = "ریز پرداختی ماهیانه";
