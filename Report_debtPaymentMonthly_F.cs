...
{
    public partial class Report_debtPaymentMonthly_F : Form
    {
        public DLibraryUtils.DLUtils DLUtilsobj;
        familial_bankEntities familial_bankEntitiescontext;
        bool openExportFile = false;
      
        public Report_debtPaymentMonthly_F()
        {
            InitializeComponent();
        }
        ...
        {
            DLUtilsobj.temperory2obj.ReportdebtpaymentMonthly(persianDateTimePicker2.Value.ToString("yyyy/MM/dd"), persianDateTimePicker1.Value.ToString("yyyy/MM/dd"));
            ...
            {
                radGridView1.Columns[0].HeaderText = "سال";
                radGridView1.Columns[1].HeaderText = "ماه";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            radPrintDocument1.RightHeader = "مبلغ واریزی اقساط به تفکیک";
