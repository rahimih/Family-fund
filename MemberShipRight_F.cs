...
namespace familial_bank
{
    public partial class MemberShipRight_F : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                MemberShipRight MemberShipRighttable = new MemberShipRight
                {
                ...
                familial_bankEntitiescontext.MemberShipRights.Add(MemberShipRighttable);
        ...
        private void MemberShipRight_F_Load(object sender, EventArgs e)
        {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            {
                    MemberShipRight MemberShipRighttable = familial_bankEntitiescontext.MemberShipRights.First(i => i.Code == code);
                    if (MessageBox.Show("اطلاعات مورد نظر ثبت گردد؟", "Confirmation", MessageBoxButtons.YesNo) == DialogResult.Yes)
                    {

                        MemberShipRighttable.Description = textBox1.Text;
                        MemberShipRighttable.Year = int.Parse(textBox3.Text);
                        MemberShipRighttable.FromDate = persianDateTimePicker1.Value.ToString("yyyy/MM/dd");
                        MemberShipRighttable.Todate = persianDateTimePicker2.Value.ToString("yyyy/MM/dd");
                        MemberShipRighttable.Cashfixed = double.Parse(textBox2.Text);

                        familial_bankEntitiescontext.SaveChanges();
                        MessageBox.Show("اطلاعات مورد نظر ثبت گردید", "Information", MessageBoxButtons.OK);
                        DLUtilsobj.EventsLogobj.insertEventsLog(usercode.ToString(), DateTime.Now.Date.ToShortDateString(), DateTime.Now.ToShortTimeString(), 14, Environment.MachineName, code);
                        this.Close();
                    }
                }
            }
